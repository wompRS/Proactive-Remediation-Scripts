...
$reg_path = "HKLM\SOFTWARE\Policies\Microsoft\Windows\Installer" # Enter the Registry key path. Remove <>.
$reg_key = "AlwaysInstallElevated" # Enter the Registry key dword name. Remove <>
